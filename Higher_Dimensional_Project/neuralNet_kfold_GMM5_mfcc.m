...
if 1
    ...
    data_path = 'C:\Users\hj\Google Drive\Final_project_data\Transformed_data\dimension_reduction\';
...
if 1
    ...
    load(strcat(data_path, 'gmm_5_mfcc_vectors'));
    % target o/p matrix
    Target = zeros(6,729);
    Target(1,1:320) = 1;
    Target(2,321:434) = 1;
...
for q = 1: 1
        for i = 1:5
            ...
            gmm_test = gmm_5(indices == i, :);
            gmm_valid = gmm_5(indices == v_i,:);
            gmm_train = gmm_5(indices ~= i & indices ~=v_i,:);
