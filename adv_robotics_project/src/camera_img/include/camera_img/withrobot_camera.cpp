...
void Camera::get_configurations(std::vector<std::string>& formats, std::vector<std::string>& controls)
{
	...
	for (std::map<std::string, v4l2_frmivalenum>::iterator it = valid_ratio_list.begin(); it != valid_ratio_list.end(); ++it) {
	...
	for (std::map<std::string, v4l2_queryctrl>::iterator it = valid_control_list.begin(); it != valid_control_list.end(); ++it) {
