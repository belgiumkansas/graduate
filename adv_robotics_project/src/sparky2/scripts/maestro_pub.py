...
class state_pub:
    ...
    def callback(self, data):
        ...
        '''do difference of IR and publish'''
        IR_diff_pub.publish((state_l - state_r))
...
if __name__=='__main__':
    ...
    IR_right_pub = rospy.Publisher("/maestro/front_IR", Float64, queue_size = 1)
    ...
    IR_diff_pub = rospy.Publisher("/maestro/IR_diff", Float64, queue_size = 1)
