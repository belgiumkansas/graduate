...
double average_rate = 10; //average frame rate based on previous tests
...
//added keychoice code to show which transform to use
static void keyChoice(void){
  int KeyPress = cvWaitKey(1);
  if((KeyPress == 83) || (KeyPress == 115)) transform_type = 0;
  else if ((KeyPress == 67) || (KeyPress == 99)) transform_type = 1;
}
